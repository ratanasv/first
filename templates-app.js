angular.module('templates-app', ['about/about.tpl.html', 'barista/barista.tpl.html', 'customer/countdown/countdown.tpl.html', 'customer/customer.tpl.html', 'customer/purchase/purchase.tpl.html', 'customer/settings/settings.tpl.html', 'home/home.tpl.html', 'login/login.tpl.html', 'picloader/picloader.tpl.html', 'secure/secure.tpl.html']);
...
angular.module("barista/barista.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("barista/barista.tpl.html",
    "<ion-content style='padding-top: 44px;'>\n" +
    "<div ng-show='orders.length === 0' class='card vir-order-animate'>\n" +
    "	<div class='item item-text-wrap'>\n" +
    "		No pending orders...\n" +
    "	</div>\n" +
    "</div>\n" +
    "\n" +
    "<div ng-repeat='order in orders' class='card vir-order-animate'>\n" +
    "	<div class='item item-divider'>\n" +
    "		Name: {{order.customer}}\n" +
    "	</div>\n" +
    "	<div class='item item-text-wrap'>\n" +
    "		<h2 ng-repeat='item in order.items' class='vir-horizontal-element'>\n" +
    "		{{item}} \n" +
    "		</h2> \n" +
    "		<div class='vir-horizontal-element vir-control'>\n" +
    "			<a class='button button-positive' ng-click='onDone(order)'>Done</a>\n" +
    "			<a class='button button-assertive' ng-click='onMore(order)'>+30</a>\n" +
    "			<a class='button button-balanced' ng-click='onLess(order)'>-30</a>\n" +
    "		</div>\n" +
    "\n" +
    "	</div>\n" +
    "	<div class='item item-divider'>\n" +
    "		Time Left: {{order.timeLeft | number : 0}} seconds\n" +
    "	</div>\n" +
    "</div>\n" +
    "\n" +
    "<div class='filler'>\n" +
...
angular.module("customer/countdown/countdown.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("customer/countdown/countdown.tpl.html",
    "<ion-content style='padding-top: 44px;'>\n" +
    "<div ng-cloak class=\"card\" ng-show='settings.name'>\n" +
    "	<div class=\"item item-text-wrap slide-left-right-ios7\" ng-show='timeRemaining > 0'>\n" +
    "		Your order will be ready in {{timeRemaining | number : 0}} seconds.\n" +
    "	</div>\n" +
    "	<div class=\"item item-text-wrap slide-left-right-ios7\" ng-show='timeRemaining < 0'>\n" +
    "		Your order is READY!\n" +
    "	</div>\n" +
...
angular.module("customer/customer.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("customer/customer.tpl.html",
    "<div class='bar bar-header bar-positive'>\n" +
    "	<h1 class='title'>{{pageTitle}}</h1>\n" +
    "</div>\n" +
    "<div ui-view='customer'></div>\n" +
    "<div class='tabs tabs-icon-top'>\n" +
    "	<a class='tab-item' ui-sref='customer.purchase'>\n" +
    "		<i class='icon ion-beer'></i>\n" +
    "		Items\n" +
    "	</a>\n" +
    "	<a class='tab-item' ui-sref='customer.countdown'>\n" +
    "		<i class='icon ion-clock'></i>\n" +
    "		Status\n" +
    "	</a>\n" +
    "	<a class='tab-item' ui-sref='customer.settings'>\n" +
...
angular.module("customer/purchase/purchase.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("customer/purchase/purchase.tpl.html",
    "<ion-content style='padding-top: 44px;'>\n" +
    "<div class='list'>\n" +
    "\n" +
    "	<div ng-repeat='(key, value) in items' class='item item-thumbnail-left item-icon-right vir-order-animate' ng-click='toggleSelection(key)' >\n" +
    "		<img ng-src='{{value.image}}'>\n" +
    "		<h2>{{value.name}}</h2>\n" +
    "		<h3> ${{value.cost}}</h3>\n" +
    "		<p>{{value.description}}</p>\n" +
    "		<i ng-show='value.selected' class='icon ion-checkmark-round'></i>\n" +
    "	</div>\n" +
    "\n" +
    "</div>\n" +
    "<div class='filler'>\n" +
    ...
    "\n" +
    "\n" +
    "<div class='bar bar-footer' style='bottom: 49px; border-style: solid; border-color: #b2b2b2'>\n" +
    "	<button ng-click='onDone()' class='button button-positive'>\n" +
    "		Send Order\n" +
    "	</button>\n" +
    "	<div class='title info'>\n" +
    "		Total Cost = ${{totalCost() | number : 2}}\n" +
    "	</div>\n" +
    "</div>");
}]);

angular.module("customer/settings/settings.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("customer/settings/settings.tpl.html",
    "<ion-content style='padding-top: 44px; padding-bottom: 51px'>\n" +
    "<div class='list'>\n" +
    "	<label class='item item-input item-stacked-label'>\n" +
    "		<span class='input-label'>First Name</span>\n" +
    "		<input type='text' placeholder='Julius' ng-model='settings.name'>\n" +
    "	</label>\n" +
    "	<label class='item item-input item-stacked-label'>\n" +
    "		<span class='input-label'>Email</span>\n" +
    "		<input type='text' placeholder='john@suhr.com' ng-model='settings.email'>\n" +
    "	</label>\n" +
    "	<label class='item item-input item-stacked-label'>\n" +
    "		<span class='input-label'>Distance</span>\n" +
    "		<input type='number' placeholder='3.14' ng-model='settings.distance'>\n" +
    "	</label>\n" +
    "</div>\n" +
    "\n" +
    "<ul class='list'>\n" +
...
angular.module("login/login.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("login/login.tpl.html",
    ...
    "Password : <input type='password' ng-model='user.password' placeholder='enter password'><br>\n" +
    "Length of the password is {{user.password.length}}<br>\n" +
    "<button ng-click='submit()'> SUBMIT </button>\n" +
    "</form>");
}]);

angular.module("picloader/picloader.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("picloader/picloader.tpl.html",
    "<form name='picLoaderForm'>\n" +
    "\n" +
    "University Name: <input type='text' ng-model='university.name'><br>\n" +
    "\n" +
    "Picture: <input type='url' name='picture' ng-model='university.pictureURL'><br>\n" +
    "\n" +
    "<span class='error' ng-show='picLoaderForm.picture.$error.url'>\n" +
    "Not valid\n" +
    "</span>\n" +
    "</form>\n" +
    "<button class='btn btn-sm btn-success' ng-click='submit()'> SUBMIT </button>\n" +
    "<hr>\n" +
    "<h4>List of Submitted Universities</h4>\n" +
    "<ul>\n" +
    "<div ng-repeat='university in universities'>\n" +
    "<li>\n" +
    "{{university.name}}\n" +
    "</li>\n" +
    "<img ng-src='{{university.pictureURL}}' width='160' height = '160'>\n" +
    "</div>\n" +
    "</ul>");
}]);

angular.module("secure/secure.tpl.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("secure/secure.tpl.html",
    "<div id='login-result'>\n" +
    "Hello User: {{user}}.\n" +
    "</div>\n" +
    "</form>");
